...
void displayProcesses(const vector<Process>& processes, const string& algorithmName) {
    cout << "Algorithm: " << algorithmName << endl;
    cout << "ID\tArrival\tBurst\tWaiting\tTurnaround\tResponse\n";
...
int main() {
    ...
    fcfs(processes);
    displayProcesses(processes, "FCFS");
    calculateAndDisplayMetrics(processes, "FCFS");

    cout << "SJN Scheduling:\n";
    sjn(processesForSjn);
    displayProcesses(processesForSjn, "SJN");
